...
void LoadResources()
{
	...
	int SL = SCREEN_WIDTH / BRICK_X;
	bricks = new vector<LPGAMEOBJECT>();
	for (int i = 0; i < SL; i++) {
		brick = new CGameObject(BRICK_X*i, MARIO_START_Y + MARIO_H, texBrick);
