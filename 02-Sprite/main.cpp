...
#define BACKGROUND_COLOR D3DCOLOR_XRGB(200, 200, 255) //mau tim
...
#define BRICK_START_X 20.0f
#define BRICK_START_Y 140.0f
...
void LoadResources()
{
	...
	brick = new Brick(BRICK_START_X, BRICK_START_Y);
